...
subject_folder = '/content/drive/MyDrive/abide_dataset/data/'
root_folder = '/content/drive/MyDrive/abide_dataset'
if not os.path.exists(data_folder):
  os.makedirs(data_folder)
shutil.copyfile(os.path.join(subject_folder,'subject_IDs_quality_checked_regular_time.txt'), os.path.join(data_folder, 'subject_IDs_quality_checked_regular_time.txt'))
...
def main():
    ...
    parser.add_argument('--pipeline', default='ccs', type=str,
